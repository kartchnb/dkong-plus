...
ACTIVATE_SECRET_STAGE				= $6290 ; The secret stage is activated if this is 1 at the end of a stage
...
SECRET_ELEVATOR_DIR					= $62a4	; The direction of the elevators on the secret level (0 = cw, 1 = ccw)
...
DK_REACHING_COUNTER					= $62af	; Used to move Donkey Kong's arm in the secret stage win animation

INTERNAL_TIMER						= $62b0	; The internal stage timer (in hex)

SECRET_ELEVATOR_MOVE_COUNT			= $62b6	; The number of times the secret stage elevators have moved in the current quadrant (count up to 24)
SECRET_ELEVATOR_QUAD				= $62b7	; The current quadrant of the elevators on the secret stage
											;         3 | 0
											;	      --+--
											;	      2 | 1
BARREL_FIRE_FREEZE					= $62b8	; Counts down from 4 to 0 between updates of the barrel fire
CAGE_BARS_REMAINING					= $62b8 ; Keeps track of the number of bars remaining on Penelope's cage (on the secret stage)
BARREL_FIRE_STATE					= $62b9		
	; 3 = Initial flare up
	; 1 = Normal burning
	; 0 = Not burning
BARREL_FIRE_FLARE_UP_TIME			= $62ba	; The time remaining until the initial flare up subsides
SECRET_ELEVATOR_PAUSE_COUNT			= $62ba	; Counter that keeps the secret stage elevators paused for a time before moving to the next quadrant
SECRET_ELEVATOR_REVERSE				= $62bb	; The elevators reverse directions when this is 1
...
FIREBALL_STRUCTS					= $6400
	...
	;  9 - The radial width of the fireball's collision boundary
	; 10 - The radial height of the fireball's collision boundary
	;
...
COLLISION_AREA_STRUCTS				= $64a0
	...
	;  7 - The sprite number of the fire ball sprite
	;  8 - The sprite palette 
	;  9 - The radial width of the collision boundary
	; 10 - The radial height of the collision boundary
COLLISION_AREA_STRUCT_1				= $64a0
COLLISION_AREA_STRUCT_2				= $64c0
CAGE_TRIGGER_STRUCT					= $64a0
	; This is the start of 4 16-byte data structures representing 
	; the triggers that open each bar of Penelope's cage on the
	; secret stage
	;
	;  0 - Trigger active
	; 
	;  3 - x coordinate of the trigger
	;
	;  5 - y coordinate of the trigger
	;
	;  7 - The sprite number of the trigger
	;  8 - The sprite palette
...
; Sprite data for the 4 cage trigger sprites on the secret stage
; 16 bytes
TRIGGER_SPRITES						= $6970
TRIGGER_SPRITE_1					= $6970
TRIGGER_SPRITE_2					= $6974
TRIGGER_SPRITE_3					= $6978
TRIGGER_SPRITE_4					= $697C
