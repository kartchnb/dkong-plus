; An attempt to produce code of the original Donkey Kong game
; as small as possible without (noticeably) affecting the game
...
; the letter selection box around each letter.  Each two byte pair is an x,y
; coordinate.  
